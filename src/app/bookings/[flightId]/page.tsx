...
// ✅ FIX: In Next.js 15, params and searchParams are Promises — must be typed and awaited
interface Props {
...
export default async function BookingPage({ params, searchParams }: Props) {
  // ✅ FIX: Await both params and searchParams before accessing their properties
